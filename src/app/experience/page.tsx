    ...
    return (
        <div className="mt-12">
            ...
            <div className="mt-6 flex flex-col gap-4">
                <div className="rounded-md flex items-center cursor-pointer w-full h-[105px] dark:backdrop-blur-2xl transition-all duration-1000 opacity-1 -translate-y-0 bg-[#ffffff0a] hover:bg-[#ffffff0f] p-4 relative">
                    ...
                    <div className='absolute right-6 font-quicksand'>
